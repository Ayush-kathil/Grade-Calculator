...
export default function Platform() {
  ...
  return (
    <div className={`min-h-screen flex flex-col items-center justify-start py-4 sm:py-6 px-3 sm:px-16 smooth-entry transition-colors duration-300 select-none font-normal ${isDark ? "bg-[#09090b] text-[#f4f4f5]" : "bg-[#fcfcfd] text-[#111111]"
      }`}>
      <div className="w-full max-w-6xl flex flex-col flex-1 gap-4 sm:gap-6 bg-transparent select-none font-normal">
        ...
        <nav className={`flex items-center justify-between border-b pb-3 gap-3 select-none ${isDark ? "border-[#27272a]" : "border-[#e4e4e7]"
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className={`text-[10px] sm:text-xs font-normal mt-1 sm:mt-1.5 select-none ${isDark ? "text-[#a1a1aa]" : "text-[#71717a]"
                }`}>
        ...
        {isSidebarOpen && (
          <div className="fixed inset-0 z-50 flex justify-end bg-black/60 backdrop-blur-sm transition-all smooth-entry select-none font-normal">
            <div className={`w-4/5 sm:w-2/3 h-full p-4 shadow-2xl flex flex-col justify-between border-l select-none font-normal ${isDark ? "bg-[#09090b] text-[#f4f4f5] border-[#27272a]" : "bg-[#fcfcfd] text-[#111111] border-[#e4e4e7]"
              }`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 font-normal">
          <div className="md:col-span-2 flex flex-col justify-between font-normal">
            <div className="mb-3 font-normal">
              <h2 className={`text-[10px] sm:text-xs font-normal tracking-wider uppercase border-b pb-1 mb-4 select-none ${isDark ? "text-[#71717a] border-[#27272a]" : "text-[#a1a1aa] border-[#e4e4e7]"
                }`}>
                Entry Panel
              </h2>
              ...
              {(mode === "CGPA" || mode === "WHAT_IF") && (
                <div className={`grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-5 border-b border-dashed pb-3 sm:pb-4 mb-3 sm:mb-4 select-none ${isDark ? "border-[#27272a]" : "border-[#e4e4e7]"
                  }`}>
                  <div>
                    <label className={`text-[10px] sm:text-xs font-normal uppercase tracking-wide block mb-1.5 ${isDark ? "text-[#a1a1aa]" : "text-[#71717a]"
                      }`}>
                      Current CGPA
                    </label>
                    <input
              ...
              {mode === "WHAT_IF" && (
                <div className={`grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-5 border-b border-dashed pb-3 sm:pb-4 mb-3 sm:mb-4 select-none font-normal ${isDark ? "border-[#27272a]" : "border-[#e4e4e7]"
                  }`}>
                  <div>
                    <label className={`text-[10px] sm:text-xs font-normal uppercase tracking-wide block mb-1.5 ${isDark ? "text-[#a1a1aa]" : "text-[#71717a]"
                      }`}>
              ...
              {mode !== "WHAT_IF" && (
                <div className="space-y-2 max-h-[290px] sm:max-h-[320px] overflow-y-auto pr-1 select-none font-normal">
                  {subjects.map((sub) => (
                    <div
                      key={sub.id}
                      className={`flex items-center justify-between gap-2.5 sm:gap-4 border-b pb-2 ${isDark ? "border-[#27272a]" : "border-[#f4f4f5]"
                        }`}
                    >
          ...
          <div className="flex flex-col justify-between select-none font-normal">
            <div>
              ...
              {isProcessing ? (
                ...
                <div className={`border p-5 text-center my-3 select-none smooth-entry rounded-2xl flex flex-col justify-between min-h-[150px] sm:min-h-[170px] ${isDark ? "border-[#27272a] bg-[#18181b]" : "border-[#e4e4e7] bg-white"
                  ...
                  <div>
                    ...
                    <div className={`text-4xl sm:text-5xl font-normal tracking-tight mt-1 select-none ${isDark ? "text-white" : "text-[#111111]"
                      }`}>
                      {result}
                    </div>
                    {confidence && (
                    ...
                    {whatIfBreakdown && (
                      <p className={`text-[11px] sm:text-xs font-normal leading-relaxed mt-3 border-t pt-3 border-dashed select-none ${isDark ? "border-[#27272a]" : "border-[#e4e4e7]"
                        }`}>
                        {whatIfBreakdown}
                      </p>
                    )}
              ...
              <div className="mt-4">
                <div className={`flex justify-between items-center border-b pb-1 mb-2.5 ${isDark ? "border-[#27272a]" : "border-[#e4e4e7]"
                  }`}>
                  <h3 className={`text-[9px] sm:text-xs font-normal uppercase tracking-wide select-none ${isDark ? "text-[#71717a]" : "text-[#a1a1aa]"
                    }`}>
                    Calculation Logs
                  </h3>
                  {history.length > 0 && (
                ...
                <div className="space-y-1.5 select-none h-[110px] sm:h-[120px] overflow-y-auto pr-0.5 font-normal">
                  {history.length === 0 ? (
                    <span className={`text-[10px] sm:text-xs italic font-normal ${isDark ? "text-[#71717a]" : "text-[#a1a1aa]"
                      }`}>
                      No recorded logs.
                    </span>
                  ) : (
                    history.map((item) => (
                      ...
                      >
                        <div className="flex flex-col">
                          <span className={`font-normal text-[10px] sm:text-base uppercase ${isDark ? "text-[#f4f4f5]" : "text-[#1c1d20]"
                            }`}>
                            {item.title}
                          </span>
                          <span className={`text-[8px] sm:text-xs ${isDark ? "text-[#71717a]" : "text-[#a1a1aa]"
                            }`}>
                            {item.mode} • {item.date}
                          </span>
                        </div>
                        <span className={`font-normal text-xs sm:text-base ${isDark ? "text-[#f4f4f5]" : "text-[#1c1d20]"
                          }`}>{item.result}</span>
                      </div>
                    ))
                  )}
